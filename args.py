...
parser.add_argument('--noise_dir', default='/Users/bdbao/Documents/Data/Speech_enhancement/Train/noise', type=str)

parser.add_argument('--voice_dir', default='/Users/bdbao/Documents/Data/Speech_enhancement/Train/clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='/Users/bdbao/Documents/Data/Speech_enhancement/Train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/Users/bdbao/Documents/Data/Speech_enhancement/Train/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='/Users/bdbao/Documents/Data/Speech_enhancement/Train/sound/', type=str)
